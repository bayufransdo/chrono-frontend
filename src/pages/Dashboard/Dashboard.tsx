    ...
    <section className="sidebar">
      ...
      <div className="sidebar__profile">
        ...
        <div className="sidebar__profile__menu">
          ...
          >
            <p className="notifications__count">{}</p>
            <svg
              width="25"
              viewBox="0 0 33 33"
              fill="none"
          ...
          <p className="notifications__content__empty">No new notifications</p>
        <?php endif ?> */}
            {/* <?php if (count($notificationsData)): ?>
          <p><small>
          ...
          <?php foreach ($notificationsData as $notification): ?>
            <div className="notifications__content__item">
              <p className="notifications__content__item-title">
                <?= htmlspecialchars($notification['title']) ?>
              </p>
              <div className="notifications__content__item-datetime">
                <p>
                  <?php
      ...
      <div className="sidebar__menu">
        ...
        <div className="sidebar__menu__logout">
          <a href="/utils/logout.php" title="Logout">
            <span>
